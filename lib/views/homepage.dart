...
class _HomePageState extends State<HomePage> {
  ...
  if (latestDocumentId != null) {
    ...
    return qrData;
  } else { return ''; // Return an empty string or handle the case when there is no latest document ID
  }
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: PreferredSize(
              ...
              child:
                  Image.asset('assets/Images/hpb2.jpg', fit: BoxFit.fitHeight)),
        ),
          ...
          child: StreamBuilder(
            ...
            builder: (context,
              ...
              children: [ 
                ...
                const Text('Your Parking Ticket: Scan on exit.',style: TextStyle(
